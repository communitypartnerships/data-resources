...
dat <- readRDS("../submodules/Cville-Heat/Data/cvillheat_blocks.RDS")
dat <- st_transform(dat, crs = 4326)
bbox <- st_bbox(dat$geometry) %>% as.vector()

neighbor_shape <- st_read("../submodules/Cville-Heat/Data/Planning_Neighborhood_Area")
...
## Temperature Changes in a Day: August, 24 2021
...
tree <- readRDS("../submodules/Cville-Heat/Data/cvilltree_blocks.RDS")
...
<div class="flex-plot">
```{r, warning=FALSE, echo=FALSE, message=FALSE, fig.width=5, fig.height=7}
...
Lee LeBoeuf, Elizabeth Mitchell, and Michele Claibourn. “Charlottesville Urban Heat Islands.” Janurary 2024. UVA Democracy Initiative Center for the Redress of Inequity through Community-Engaged Scholarship.