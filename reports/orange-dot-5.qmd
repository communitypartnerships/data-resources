...
author: "Ridge Schuyler, Michele Claibourn, Lee LeBoeuf, Elizabeth Mitchell"
...
# ACS data
tractdat <- read_csv("../submodules/orange-dot/OrangeDot5_files/data/acs_tract_orangedot.csv")
tractdat$GEOID <- as.character(tractdat$GEOID)
countydat <- read_csv("../submodules/orange-dot/OrangeDot5_files/data/acs_county_orangedot.csv")

# tract names 
tnames <- read_csv("../submodules/orange-dot/OrangeDot5_files/data/tractnames.csv")
...
# Spatial data
geo <- readRDS("../submodules/orange-dot/OrangeDot5_files/data/cvilleODreport_tracts.RDS")
...
expenses <- read_csv("../submodules/orange-dot/OrangeDot5_files/data/Expenses-SH-2kids.csv")
...
knitr::include_graphics("../submodules/orange-dot/OrangeDot5_files/images/PictureChart.png")
```
<br/>
...
knitr::include_graphics("../submodules/orange-dot/OrangeDot5_files/images/WealthGap.png")
```
<br/>
...
knitr::include_graphics("../submodules/orange-dot/OrangeDot5_files/images/IncomeGap.jpg")
```
<br/>
...
leaflet() %>% 
  ...
  addPolygons(data = ACmap,
              ...
              popup = paste0("Percent of families: ", round(ACmap$perc_AllFamUnder35kE,1), "%", "<br>",
                             "Number of families: ", ACmap$AllFamUnder35kE, "<br>",
                             "Census Tract: ", ACmap$NAME.x, "<br>",
                             "Area Name: ", ACmap$tractname)) %>% 
...
leaflet() %>% 
  ...
  addPolygons(data = BCmap,
              ...
              popup = paste0("Percent of families: ", round(BCmap$perc_AllFamUnder35kE,1), "%", "<br>",
                             "Number of families: ", BCmap$AllFamUnder35kE, "<br>",
                             "Census Tract: ", BCmap$NAME.x, "<br>",
                             "Area Name: ", BCmap$tractname)) %>% 
...
### Charlottesville City {.unlisted .unnumbered}
```{r}
...
leaflet() %>% 
  ...
  addPolygons(data = CCmap,
              ...
              popup = paste0("Percent of families: ", round(CCmap$perc_AllFamUnder35kE,1), "%", "<br>",
                             "Number of families: ", CCmap$AllFamUnder35kE, "<br>",
                             "Census Tract: ", CCmap$NAME.x, "<br>",
                             "Area Name: ", CCmap$tractname)) %>% 
...
leaflet() %>% 
  ...
  addPolygons(data = FCmap,
              ...
              popup = paste0("Percent of families: ", round(FCmap$perc_AllFamUnder35kE,1), "%", "<br>",
                             "Number of families: ", FCmap$AllFamUnder35kE, "<br>",
                             "Census Tract: ", FCmap$NAME.x, "<br>",
                             "Area Name: ", FCmap$tractname)) %>% 
...
leaflet() %>% 
  ...
  addPolygons(data = GCmap,
              ...
              popup = paste0("Percent of families: ", round(GCmap$perc_AllFamUnder35kE,1), "%", "<br>",
                             "Number of families: ", GCmap$AllFamUnder35kE, "<br>",
                             "Census Tract: ", GCmap$NAME.x, "<br>",
                             "Area Name: ", GCmap$tractname)) %>% 
...
leaflet() %>% 
  ...
  addPolygons(data = LCmap,
              ...
              popup = paste0("Percent of families: ", round(LCmap$perc_AllFamUnder35kE,1), "%", "<br>",
                             "Number of families: ", LCmap$AllFamUnder35kE, "<br>",
                             "Census Tract: ", LCmap$NAME.x, "<br>",
                             "Area Name: ", LCmap$tractname)) %>% 
...
leaflet() %>% 
  ...
  addPolygons(data = NCmap,
              ...
              popup = paste0("Percent of families: ", round(NCmap$perc_AllFamUnder35kE,1), "%", "<br>",
                             "Number of families: ", NCmap$AllFamUnder35kE, "<br>",
                             "Census Tract: ", NCmap$NAME.x, "<br>",
                             "Area Name: ", NCmap$tractname)) %>% 
...
The authors of this report are: 
  ...
  * Ridge Schuyler, Dean, Division of Community Self-Sufficiency Programs - Network2Work\@PVCC, Piedmont Virginia Community College, originated the Orange Dot Report in 2011 and has authored three prior updates (2015, 2018, 2021). 
  ...
  * Lee LeBoeuf, Research Data Fellow, The Equity Center, University of Virginia and Ph.D. Candidate, Department of Psychology, University of Virginia.
...
Ridge Schuyler, Michele Claibourn, Lee LeBoeuf, and Elizabeth Mitchell. "Orange Dot Report 5.0: Family Self-Sufficiency in the Charlottesville Region." Network2Work\@PVCC, Piedmont Virginia Community College and The Equity Center, a UVA Karsh Institute of Democracy Center for the Redress of Inequity Through Community-Engaged Scholarship. Published October 27, 2022.
