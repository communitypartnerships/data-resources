...
[Download Report PDF](../pdfs/steppping-stones-report-2023.pdf){.external target="_blank"}
...
##### Percent of Incoming Kindergarteners At or Above PALS benchmarks for Albemarle County Public Schools, Charlottesville City Schools, and Virginia Public Schools {.unnumbered}
```{r, fig.alt = "Line chart comparing percentages of incoming kindergarteners At or Above PALS benchmarks for Albemarle, Charlottesville, and Virginia by school year over the period from 2002-03 to 2019-20. Local trends have been relatively steady and in line with state trends, holding over 75% during the period, with 83% for Charlottesville and 81% for Albemarle in 2019-20."}
pals_kinder <- read_csv("../submodules/stepping-stones/data/pals_kindergarten_updated.csv")
...
```{r, fig.alt = "Line chart with y-axis showing percent of students taking the 3rd grade Math SOL, x-axis showing school year, from 2005-06 to 2021-22, and lines for percent of students passing for Albemarle, Charlottesville, and Virginia. Annotations at 2011-12 for Implementation of revised math standards and at 2019-20 when SOLs not conducted due to COVID-19 Pandemic. In 2021-22 percents were 62% for Albemarle and 57% for Charlottesville."}
# Read in data
sols <- read_csv("../submodules/stepping-stones/data/sol_pass.csv")
sols <- sols %>% 
...
```{r, fig.alt = "Line chart with y-axis showing percent of students taking the 5th grade Math SOL, x-axis showing school year, from 2005-06 to 2021-22, and lines for percent of students passing for Albemarle, Charlottesville, and Virginia. Annotations at 2011-12 for Implementation of revised math standards and at 2019-20 when SOLs not conducted due to COVID-19 Pandemic. In 2021-22 percents were 63% for Albemarle and 40% for Charlottesville."}
sols %>% 
...
```{r, fig.alt = "Line chart with y-axis showing percent of students taking the 8th grade Math SOL, x-axis showing school year, from 2005-06 to 2021-22, and lines for percent of students passing for Albemarle, Charlottesville, and Virginia. Annotations at 2011-12 for Implementation of revised math standards and at 2019-20 when SOLs not conducted due to COVID-19 Pandemic. In 2021-22 percents were 37% for Albemarle and 19% for Charlottesville."}
sols %>% 
...
```{r, fig.alt = "Line chart with y-axis showing percent of students taking the 3rd grade Reading SOL, x-axis showing school year, from 2005-06 to 2021-22, and lines for percent of students passing for Albemarle, Charlottesville, and Virginia. Annotations at 2012-13 for Implementation of revised reading standards and at 2019-20 when SOLs not conducted due to COVID-19 Pandemic. In 2021-22 percents were 66% for Albemarle and 70% for Charlottesville."}
...
```{r, fig.alt = "Line chart with y-axis showing percent of students taking the 5th grade Reading SOL, x-axis showing school year, from 2005-06 to 2021-22, and lines for percent of students passing for Albemarle, Charlottesville, and Virginia. Annotations at 2012-13 for Implementation of revised reading standards and at 2019-20 when SOLs not conducted due to COVID-19 Pandemic. In 2021-22 percents were 72% for Albemarle and 51% for Charlottesville."}
...
```{r, fig.alt = "Line chart with y-axis showing percent of students taking the 8th grade Reading SOL, x-axis showing school year, from 2005-06 to 2021-22, and lines for percent of students passing for Albemarle, Charlottesville, and Virginia. Annotations at 2012-13 for Implementation of revised reading standards and at 2019-20 when SOLs not conducted due to COVID-19 Pandemic. In 2021-22 percents were 75% for Albemarle and 54% for Charlottesville."}
# Grade 8 Plot
sols %>% 
...
```{r, fig.alt = "Line chart with y-axis showing percent of enrolled students, x-axis showing school year, from 2010-11 to 2021-22, and lines for percent of students identified to receive special services for Albemarle, Charlottesville, and Virginia. In 2021-22 percents were 13% for Albemarle and 14% for Charlottesville."}
sped_services <- read_csv("../submodules/stepping-stones/data/sped_services.csv")
...
An English Learner (EL) is a student who is not fully proficient in English and requires language-based accommodations to effectively learn during their K-12 education. Multilingual learners have been a growing segment of the student population in Virginia but [have not always had access to needed resources](https://thecommonwealthinstitute.org/research/changing-gears-addressing-virginias-persistent-lack-of-support-for-english-learner-students/).
  ...
  - __How is this measured?:__ The count of identified students who speak English as a second or other language and are emergent in the speaking, reading, writing, and/or understanding of English as a percent of all students in the school division. Former English Learners are not included in the count.
...
```{r, fig.alt = "Line chart with y-axis showing percent of enrolled students, x-axis showing school year, from 2003-04 to 2022-23, and lines for percent of students identified as English Learners for Albemarle, Charlottesville, and Virginia. In 2021-22 percents were 9% for Albemarle and 14% for Charlottesville."}
english_language_learners <- read_csv("../submodules/stepping-stones/data/english_language_learners.csv")
...
```{r, fig.alt = "Line chart with y-axis showing percent of students, x-axis showing school year, from 2007-08 to 2021-22, and lines for percent of students in attendance for Albemarle, Charlottesville, and Virginia. In 2021-22 percents were 94% for Albemarle and 93% for Charlottesville. Annotation for school schedules impacted by the COVID-19 Pandemic for the shaded school years 2019-20 to 2020-21."}
average_daily_attendance <- read_csv("../submodules/stepping-stones/data/average_daily_attendance.csv")
...
```{r, fig.alt = "Line chart with y-axis showing percent of student cohort, x-axis showing graduation year, from 2008 to 2022, and lines for percent of students graduating for Albemarle, Charlottesville, and Virginia. In 2022 percents were 94% for Albemarle and 93% for Charlottesville."}
graduation_rates <- read_csv("../submodules/stepping-stones/data/graduation_rates.csv")
...
```{r, fig.alt = "Line chart with y-axis showing percent of graduating students, x-axis showing graduation year, from 2008 to 2020, and two sets of lines, solid and dashed, for Albemarle, Charlottesville, and Virginia. Solid lines show percent of students attending any institution, with values in 2020 of 75% for Albemarle and 64% for Charlottesville. Dashed lines show percent of students attending a 4-year institution, with values in 2020 of 52% for Albemarle and 43% for Charlottesville."}
postsecondary_education <- read_csv("../submodules/stepping-stones/data/postsecondary_education.csv")
...
```{r, fig.alt = "Line chart with y-axis showing percent of residents, x-axis showing ACS survey period, from 2005-2010 to 2016-2021, and lines for percent of residents with a high school degree for Albemarle, Charlottesville, and Virginia. For 2016-2021 percents were 93% for Albemarle and 92% for Charlottesville."}
hsdegree_attainment <- read_csv("../submodules/stepping-stones/data/hsdegree_attainment.csv")
...
```{r, fig.alt = "Line chart with y-axis showing percent of adults, x-axis showing year, from 2000 to 2021, and lines for percent of registered voters for Albemarle, Charlottesville, and Virginia. In 2021 percents were 96% for Albemarle and 86% for Charlottesville. Annotations for presidential elections at the years 2000, 2004, 2008, 2012, 2016, and 2020."}
voter_reg <- read_csv("../submodules/stepping-stones/data/vote_reg.csv")
voter_reg <- voter_reg %>% 
  # filter(year != 2021) %>% 
...
```{r, fig.alt = "Line chart with y-axis showing income per capita, x-axis showing year, from 2000 to 2021, and two sets of lines, solid and dashed, for Albemarle and Charlottesville combined and Virginia. Solid lines show raw income, with values in 2021 of 85,867 for Albemarle and Charlottesville combined. Dashed lines show inflation-adjusted income, with values in 2021 of 69,099 for Albemarle and Charlottesville combined. Annotation for economic recession for the shaded years 2007 to 2009."}
per_cap_income <- read_csv("../submodules/stepping-stones/data/per_cap_income.csv")
...
##### Percent of Youth (16-19) Participating in the Labor Force for Albemarle County, City of Charlottesville, and Virginia
```{r, fig.alt = "Line chart with y-axis showing percent of youth, x-axis showing ACS survey period, from 2005-2010 to 2016-2021, and lines for percent of youth in the labor force for Albemarle, Charlottesville, and Virginia. For 2016-2021 percents were 24% for Albemarle and 32% for Charlottesville."}
youth_employment <- read_csv("../submodules/stepping-stones/data/youth_employment_status.csv")
...
##### Percent of Youth (16-19) in the Labor Force Experiencing Unemployment for Albemarle County, City of Charlottesville, and Virginia
```{r, fig.alt = "Line chart with y-axis showing percent of youth in labor force, x-axis showing ACS survey period, from 2005-2010 to 2016-2021, and lines for percent of youth unemployment for Albemarle, Charlottesville, and Virginia. For 2016-2021 percents were 8% for Albemarle and 7% for Charlottesville."}
youth_employment %>%
...
```{r, fig.alt = "Line chart with y-axis showing percent of children, x-axis showing year, from 2000 to 2021, and lines for percent of children living below poverty threshold for Albemarle, Charlottesville, and Virginia. In 2021 percents were 20% for Albemarle with n value 1,453, and 8% for Charlottesville with n value 1,821. Annotations for Covid-19 economic stimulus payments at the years 2020 and 2021."}
child_poverty <- read_csv("../submodules/stepping-stones/data/child_pov.csv")
...
```{r, fig.alt = "Line chart with y-axis showing percent of students, x-axis showing school year, from 2004-05 to 2022-23, and lines for percent of economically disadvantaged students for Albemarle, Charlottesville, and Virginia. In 2022-23 percents were 31% for Albemarle with n value 4,333, and 54% for Charlottesville with n value 2,404. Annotations at 2018-19 for CCS begin participating in USDA CEP and 2021-22 for ACPS begin participation in USDA CEP."}
economically_disadvantaged_students <- read_csv("../submodules/stepping-stones/data/economically_disadvantaged_students.csv")
...
```{r, fig.alt = "Line chart with y-axis showing percent of renters, x-axis showing ACS survey period, from 2004-2009 to 2016-2021, and lines for percent of cost-burdened renters for Albemarle, Charlottesville, and Virginia. For 2016-2021 percents were 43% for Albemarle and 51% for Charlottesville."}
rent_burdened <- read_csv("../submodules/stepping-stones/data/rent_burdened.csv")
...
```{r, fig.alt = "Line chart with y-axis showing percent of homeowners, x-axis showing ACS survey period, from 2005-2010 to 2016-2021, and lines for percent of cost-burdened homeowners for Albemarle, Charlottesville, and Virginia. For 2016-2021 percents were 18% for Albemarle and 18% for Charlottesville."}
homeowner_burden <- read_csv("../submodules/stepping-stones/data/homeowner_burden.csv")
...
```{r, fig.alt = "Line chart with y-axis showing number of people, x-axis showing year, from 2009 to 2022, and three lines, solid, dashed and dotted, for the Charlottesville region. Solid line shows total people experiencing homelessness, with value in 2022 of 266. Dashed line shows sheltered, with value in 2022 of 240. Dotted line shows unsheltered with value in 2022 of 26. Annotations for the opening of the Crossings in 2012 and in 2022 for Covid-19 heightened impact of high housing costs and lack of affordable housing."}
pitcount_homeless <- read_csv("../submodules/stepping-stones/data/pitcount_homeless.csv")
...
```{r, fig.alt = "Line chart with y-axis showing percent of people giving birth, x-axis showing year, from 2006 to 2020, and lines for percent of people with prenatal care for Albemarle, Charlottesville, and Virginia. In 2020 percents were 95% for Albemarle and 95% for Charlottesville. Annotations at 2010 for Affordable Care Act passed and 2019 for Virginia expanded medicaid coverage."}
prenatal_first_trimester <- read_csv("../submodules/stepping-stones/data/prenatal_first_trimester.csv")
...
```{r, fig.alt = "Line chart with y-axis showing percent of infants, x-axis showing three-year period, from 2000-2002 to 2018-2020, and lines for percent of low birth-weight babies for Albemarle, Charlottesville, and Virginia. In 2018-2020 percents were 7% for Albemarle and 6% for Charlottesville."}
low_birth_weight <- read_csv("../submodules/stepping-stones/data/low_birth_weight.csv")
...
##### Rate per 1,000 Births of Infants who Died before their 1st Birthday for Albemarle County, City of Charlottesville, and Virginia
```{r, fig.alt = "Line chart with y-axis showing percent of infants, x-axis showing three-year period, from 2000-2002 to 2018-2020, and lines for percent of infant deaths for Albemarle, Charlottesville, and Virginia. In 2018-2020 percents were 6% for Albemarle and 3% for Charlottesville."}
infant_mortality <- read_csv("../submodules/stepping-stones/data/infant_mortality.csv")
...
```{r, fig.alt = "Line chart comparing rate of teen pregnancy in teens ages 15-17 (per 1,000) for Albemarle, Charlottesville, and Virgina. The y-axis represents the rate per 1,000 teens ages 15-17, and the x-axis represents the three-year period from 2000-2002 to 2018-2020. In 2018-2020, the rate was 5 per 1,000 for Albemarle and 9 per 1,000 for Charlottesville."}
teen_pregnancy_birth <- read_csv("../submodules/stepping-stones/data/teen_pregnancy_birth.csv")
...
```{r, fig.alt = "Line chart comparing rate of births to teens ages 15-17 for Albemarle, Charlottesville, and Virgina. The y-axis represents the rate per 1,000 teens ages 15-17, and the x-axis represents the three-year period from 2000-2002 to 2018-2020. In 2018-2020, the rate was 5 per 1,000 for Albemarle and 9 per 1,000 for Charlottesville."}
teen_pregnancy_birth %>% 
...
```{r, fig.alt = "Line chart comparing rate of sexually transmitted infections in youth ages 10-19 (per 1,000) for Albemarle, Charlottesville, and Virgina. The y-axis represents the rate per 1,000 youth ages 10-19, and the x-axis represents the three-year rate from 2001-2003 to 2019-2021. In 2019-2021, the rate was 5 per 1,000 for Albemarle and 10 per 1,000 for Charlottesville."}
youth_sti <- read_csv("../submodules/stepping-stones/data/youth_sti.csv")
youth_sti <- youth_sti %>% 
...
```{r, fig.alt = "Line chart comparing the percent of children in two-parent households from the ACS 5-year in Albemarle, Charlottesville, and Virgina. The y-axis represents the percent of children and the x-axis represents time from the 2005-2010 estimate to the 2016-2021 estimate. Rates are fairly consistent in all three localities, hovering between roughly 55% and 77%, though the rate in Charlottesville is consistently the lowest and the rate in Albemarle is consistently the highest."}
children_twoparents <- read_csv("../submodules/stepping-stones/data/children_twoparents.csv")
...
```{r, fig.alt = "Line chart comparing annual divorce rate (per 1,000 people) for Albemarle, Charlottesville, and Virgina with data from the Virginia Department of Health. The y-axis represents the rate per 1,000 people and the x-axis represents the year from 2000 to 2018. With the exception of 2001, rates are consistently highest for the state relative to Albemarle and Charlottesville. Overall, for all three localities, rates hover between 1 and 5 per 1,000 people."}
divorce_vdh <- read_csv("../submodules/stepping-stones/data/divorce_vdh.csv")
...
```{r, fig.alt = "Line chart comparing annual divorce rate (per 1,000 people) for Albemarle, Charlottesville, and Virgina with data from the Virginia Circuit Court. The y-axis represents the rate per 1,000 people and the x-axis represents the year from 2000 to 2018. Data are missing for Virginia from 2014 to 2020. With the exception of 2001, rates are consistently lowest in Charlottesville. Overall, for all three localities, rates hover between 1 and 7 per 1,000 people."}
divorce_circuit <- read_csv("../submodules/stepping-stones/data/divorce_circuit.csv")
...
```{r, fig.alt = "Line chart comparing annual number referrals to child protective services (per 1,000 children) for Albemarle, Charlottesville, and Virgina. The y-axis represents the rate per 1,000 children and the x-axis represents the fiscal year from the 2008-09 fiscal year to the 2019-2020 fiscal year. Rates for all localities stayed between 12 and 50 per 1,000 children. Though rates fluctuate somewhat year to year, they appear to be relatively stable."}
child_welfare_reports <- read_csv("../submodules/stepping-stones/data/child_welfare_reports.csv")
...
```{r, fig.alt = "Line chart comparing annual number of children (per 1,000) in foster care for Albemarle, Charlottesville, and Virgina. The y-axis represents the rate per 1,000 children and the x-axis represents the year from 2006 to 2022. Rates are consistently highest in Charlottesville, though the gap is shrinking between Charlottesville and the other localities. In 2022, the Charlottesville rate was 8 per 1,000 children and the Albemarle rate was 5 per 1,000 children."}
foster_care <- read_csv("../submodules/stepping-stones/data/foster_care.csv")
...
```{r, fig.alt = "Line chart comparing annual number of incidents (per 1,000 students) disciplined at school for alcohol and drug violations for Albemarle, Charlottesville, and Virginia, though data are not shown for Charlottesville and Albemarle from 2013 to 2018. The y-axis represents the rate of incidents per 1,000 students and the x-axis represents the school year from the 2006-07 school year to the 2020-2021 school year. The Rates are similar in all three localities, and this outcome is relatively rare, hovering between 0 and roughly 10 per 1,000 students."}
school_alcdrugs_dcv <- read_csv("../submodules/stepping-stones/data/school_alcdrugs_dcv.csv")
...
```{r, fig.alt = "Line chart comparing annual number of students (per 1,000) disciplined at school for physical violence in Albemarle, Charlottesville, and Virginia, though data are not shown for Charlottesville and Albemarle from 2013 to 2018. The y-axis represents the rate of incidents per 1,000 students and the x-axis represents the school year from the 2006-07 school year to the 2020-2021 school year. Rates in Charlottesville were highest in 2006-07 at over 60 per 1,000, but have declined dramatically. Albemarle rates were much lower from 2006-07 to 2012-13 at less than 15 per 1,000, but rates in all three localities were similar between 2017-18 and 2020-21."}
school_violence_dcv <- read_csv("../submodules/stepping-stones/data/school_violence_dcv.csv")
...
```{r, fig.alt = "Line chart comparing annual number of students (per 1,000) disciplined at school for possessing a weapon in Albemarle, Charlottesville, and Virginia, though data are not shown for Charlottesville and Albemarle from 2013 to 2018. The y-axis represents the rate of incidents per 1,000 students and the x-axis represents the school year from the 2006-07 school year to the 2020-2021 school year. Rates are similar in all three localities, and this outcome is relatively rare, hovering between 0 and roughly 15 per 1,000 students."}
school_weapons_dcv <- read_csv("../submodules/stepping-stones/data/school_weapons_dcv.csv")
...
```{r, fig.alt = "Line chart comparing annual number of students who received an out of school suspension (per 1,000) in Albemarle, Charlottesville, and Virgina, though data are only shown for Virginia from 2016-17 to 2020-21. The y-axis represents the rate per 1,000 students and the x-axis represents the school year from the 2002-04 school year to the 2020-2021 school year. Rates were highest in Charlottesville from 2003 to 2015, though they have been declining substantially. Since 2016, rates in all three localities have been very similar, and they hovered around 50 students per 1000 between 2016 and 2020, though dropped to 1 or fewer in 2020."}
school_suspensions <- read_csv("../submodules/stepping-stones/data/school_suspensions.csv")
...
```{r, fig.alt = "Line chart comparing annual number of youth ages 10 to 17 (per 1,000) for whom a court has issued a judgment that they are in need of supervision in Albemarle, Charlottesville, and Virginia, though data are only shown for Virginia from 2018 to 2022. The y-axis represents the rate per 1,000 youth and the x-axis represents the year from 2010 to 2022. Since 2019, the rates in Albemarle, Charlottesville, and Virginia have been very similar, though rates were highest in Virginia in 2016."}
child_need_services <- read_csv("../submodules/stepping-stones/data/child_need_services.csv")
...
```{r, fig.alt = "Line chart comparing annual number of youth ages 10 to 17 (per 1,000) who received a delinquent judgment in the Juvenile and Domestic Relations court in Albemarle, Charlottesville, and Virginia. The y-axis represents the rate per 1,000 youth ages 10 to 17 and the x-axis represents the year from 2010 to 2022. Data are only shown for Virginia from 2018 to 2022. Charlottesville rates are consistently higher than Albemarle, but both are decreasing over time, and the gap between them is also shrinking."}
juvenile_delinquency <- read_csv("../submodules/stepping-stones/data/juvenile_delinquency.csv")
...
```{r, fig.alt = "Line chart comparing annual number of youth under 18 (per 1,000) who have been arrested for underage alcohol use in Albemarle, Charlottesville, and Virginia from 1999 to 2021. The y-axis represents the rate per 1,000 youth under 18, and the x-axis represents the year  from 2010 to 2022. Since 2015, the number of youths arrested has less than or roughly equal to 5 per 1,000 youth for Albemarle, Charlottesville, and Virginia. Rates have been very similar for all three localities since 2012, though slightly higher in Albemarle from 2006 to 2012."}
arrests_alcoholrelated <- read_csv("../submodules/stepping-stones/data/arrests_alcoholrelated.csv")
...
```{r, fig.alt = "Line chart comparing annual number of youth under 18 (per 1,000) who have been arrested for crimes against persons in Albemarle, Charlottesville, and Virginia. The y-axis represents the rate per 1,000 youth under 18, and the x-axis represents the year from 1999 to 2021. Since 2015, the number of youth arrested has been 5 per 1,000 youth for Albemarle, Charlottesville, and Virginia. Overall, the rate has been steadily declining for all three localities since 2011."}
arrests_crimesagainstpersons <- read_csv("../submodules/stepping-stones/data/arrests_crimesagainstpersons.csv")
...
This report is a collaboration of many contributors, including:
  ...
  - The City of Charlottesville’s Department of Human Services: Misty Graves (Director), Daniel Fairley (Youth Opportunity Coordinator)
  - The UVA Equity Center, Democratization of Data Initiative: Michele Claibourn (Director of Equitable Analysis), Beth Mitchell (Data Scientist for Equitable Analysis), Nina Schoonover (Data Scientist for Educational Equity), and Lee LeBoeuf (Equity Data Fellow)
  - Batten School of Leadership and Public Policy, Public Interest Data: Ethics & Practice Class: Michele Claibourn (Faculty), Vani Agarwal, Amruta Binoy, Charlie Bruce, Katherine Driebe, Connor Eads, Jayla Hart, Fara Islam, Somin Lee, Michael Lutton, Lekha Mereddy, Maria Morrissey, Owayne Owens, Lily Slonim, Ramya Tella, Mary Katherine West, and Melinda Wong

### About the Department of Human Services (DHS) {.small-h3}

The [Department of Human Services (DHS)](https://charlottesville.org/224/Human-Services) was created in 2010 to serve as a human services policy advisor to the City Manager in order to implement the social policy initiatives of the Charlottesville City Council. The vision of the DHS is to serve as the community’s premier provider in meeting the therapeutic needs of youth and families, supporting the community’s efforts to improve equity, and address poverty and its impacts. 

The DHS manages the Youth Council, Youth Opportunity Project initiative, Juvenile Justice Advisory Committee, and other related community grants and initiatives. They provide services and programs that improve and support the resilience, health, and well-being of youth, families, and community organizations. 

### About the Equity Center and Democratization of Data Initiative {.small-h3}

Established in 2019, the mission of the [UVA Equity Center](https://virginiaequitycenter.org/) is to tangibly redress racial and economic inequity in university communities by advancing a transformative approach to the fundamental research mission. We envision universities that serve local communities by bringing rich research resources to bear on the work of redressing poverty and racial inequality and equip students to lead in building a just society.
...
### About Public Interest Data: Ethics and Practice, UVA Batten School of Leadership and Public Policy {.small-h3}

[Public Interest Data: Ethics & Practice](https://pidep23.mclaibourn.org/static/syllabus/) (LPPS 5730) is intended to provide students experience with data science within a framework of data ethics in service of equity-oriented public policy. The class goals include:
...
Charlottesville Department of Human Services and the UVA Equity Center. _Stepping Stones: A Report on Community Well-Being of Children and Families in the Charlottesville/Albemarle Area_. Published June 2023.
